        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_Neighborhood = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    ...
                    Address_Location = table.Column<Point>(type: "geography(Point, 4326)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrivateChatRoomId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatRoomInvites_Users_InviteeUserId",
                        column: x => x.InviteeUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatRoomInvites_Users_InviterUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatRoomMessages_Users_SenderUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatRoomUserMaps", x => new { x.ChatRoomId, x.UserId });
                    table.ForeignKey(
                        name: "FK_ChatRoomUserMaps_ChatRooms_ChatRoomId",
                        column: x => x.ChatRoomId,
                        principalTable: "ChatRooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatRoomUserMaps_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatRoomInvites_InviteeUserId",
                table: "ChatRoomInvites",
                column: "InviteeUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatRoomInvites_InviterUserId",
                table: "ChatRoomInvites",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatRoomMessages_SenderUserId",
                table: "ChatRoomMessages",
                column: "SenderUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatRoomUserMaps_UserId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Blacklist_Branches_BranchId",
                table: "Blacklist",
                column: "BranchId",
                principalTable: "Branches",
                principalColumn: "Id",
